...
import wrteam.Omagric.app.adapter.SliderAdapter;
...
import static wrteam.Omagric.app.helper.ApiConfig.AddMultipleProductInCart;
import static wrteam.Omagric.app.helper.ApiConfig.AddOrRemoveFavorite;
import static wrteam.Omagric.app.helper.ApiConfig.GetSettings;


public class ProductDetailFragment extends Fragment {
    static ArrayList<Slider> sliderArrayList;
    TextView tvMfg, tvMadeIn, txtProductName, txtqty, txtPrice, txtOriginalPrice, txtDiscountedPrice, txtMeasurement, txtstatus, tvReturnable, tvCancellable, tvTitleMadeIn, tvTitleMfg;
    ...
    LinearLayout lytshare, lytsave, lytsimilarproducts;
    int size, count;
    View root;
    int vpos;
    String from, id;
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        lytsimilarproducts = root.findViewById(R.id.lytsimilarproducts);
                ...
                if (AppController.isConnected(activity)) {
                    ...
                    if (!(count <= 0)) {
                        if (count != 0) {
                            ...
                            if (isLogin) {
                                if (Constant.CartValues.containsKey(priceVariationslist.get(0).getId())) {
