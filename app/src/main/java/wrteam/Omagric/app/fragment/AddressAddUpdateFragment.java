...
import wrteam.Omagric.app.adapter.AddressAdapter;
...
import wrteam.Omagric.app.model.Address;
import wrteam.Omagric.app.model.City;

import static android.content.Context.INPUT_METHOD_SERVICE;
import static wrteam.Omagric.app.fragment.AddressListFragment.addressAdapter;
import static wrteam.Omagric.app.fragment.AddressListFragment.addresses;
import static wrteam.Omagric.app.fragment.AddressListFragment.recyclerView;
...
public class AddressAddUpdateFragment extends Fragment implements OnMapReadyCallback {
    ...
    View root;
    String city , area = "3", cityId, areaId;
    ...
    Session session;
    String isDefault = "0";
    TextView tvUpdate, edtName,cityspinner, edtMobile, edtAlternateMobile, edtAddress, edtLanmark, edtPinCode, edtState, edtCounty;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cityspinner.setText(session.getData(Session.KEY_CITY_ID));
  ...
  //          areaSpinner.setSelection(0);
    ...
    private void AddUpdateAddress() {
        ...
        if (cityspinner.getText().toString().trim().isEmpty()) {
            cityspinner.setError("Please enter City!");
...
//            areaSpinner.performClick();
            ...
            params.put(Constant.CITY_ID,  cityspinner.getText().toString().trim());
           // params.put(Constant.CITY_ID, city);
            params.put(Constant.AREA_ID, "area");
