...
public class MapFragment extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, GoogleMap.OnMarkerDragListener, GoogleMap.OnMapLongClickListener {
    ...
    View root;
    TextView tvLocation, tvSatellite, tvStreet;
    Session session;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        } else if (from.equalsIgnoreCase("profile") || from.equalsIgnoreCase("login")) {
            bundleLatitude = Double.parseDouble(session.getCoordinates(Session.KEY_LATITUDE));
            bundleLongitude = Double.parseDouble(session.getCoordinates(Session.KEY_LONGITUDE));
        }
        ...
        btnUpdateLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (from.equalsIgnoreCase("address")) {
                    ...
                    ProfileFragment.tvCurrent.setText(getAddress(latitude, longitude, activity));
                    ProfileFragment.mapFragment.getMapAsync(ProfileFragment.mapReadyCallback);
                } else if (from.equalsIgnoreCase("login")) {
                    session.setData(Session.KEY_LATITUDE, "" + latitude);
                    session.setData(Session.KEY_LONGITUDE, "" + longitude);
                    LoginActivity.edtaddress.setText(getAddress(latitude, longitude, activity));
                    ProfileFragment.mapFragment.getMapAsync(LoginActivity.mapReadyCallback);
                }
