...
import wrteam.Omagric.app.adapter.NotificationAdapter;
...
import wrteam.Omagric.app.model.Notification;
...
public class NotificationFragment extends Fragment {
    ...
    private void getNotificationData(final int startoffset) {
        ...
        params.put(Constant.OFFSET, "" + Constant.OFFSET_NOTIFICATION);
                                            ...
                                            if (notifications.size() < total) {
                                                if (!isLoadMore) {
                                                    if (linearLayoutManager.findLastCompletelyVisibleItemPosition() == notifications.size() - 1) {
                                                        ...
                                                        Constant.OFFSET_NOTIFICATION += Constant.LOAD_ITEM_LIMIT;
