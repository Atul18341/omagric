...
public class PriceVariation implements Serializable {
    private String id, product_id, type, measurement, cart_count, measurement_unit_id, productPrice, price, discounted_price, serve_for, stock, stock_unit_id, measurement_unit_name, stock_unit_name, discountpercent;
    private int qty;
