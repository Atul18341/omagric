package wrteam.Omagric.app.model;
...
public class OrderTracker implements Serializable {
    ...
    public String return_status, cancelable_status, till_status, username, id, user_id, order_id, product_variant_id, quantity, price, discount, dPercent, dAmount, sub_total, tax_amt, tax_percent, deliver_by, date_added, name, image, measurement, unit, status, statusdate, mobile, delivery_charge, payment_method, address, final_total, total, walletBalance, promoCode, promoDiscount, activeStatus, activeStatusDate;
