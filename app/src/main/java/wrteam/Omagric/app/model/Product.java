...
public class Product implements Serializable {
    ...
    private String id, name, slug, subcategory_id, row_order, image, description, status, date_added, category_id, indicator, manufacturer, made_in, return_status, cancelable_status, till_status;
