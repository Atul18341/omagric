...
public class Constant {
    ...
    //You can change values here as per your requirements
    public static String MAINBASEUrl = "https://admin.omagric.com/"; //Admin panel url
    ...
    public static int LOAD_ITEM_LIMIT = 100; //Load items limit in listing ,Maximum load item once
    ...
    public static int OFFSET_TRANSACTION = 0;
    public static int OFFSET_CART = 0;
    public static int OFFSET_WALLET_TRANSACTION = 0;
    public static int OFFSET_NOTIFICATION = 0;
    public static int OFFSET_ADDRESS = 0;
    public static int FAVORITE_OFFSET = 0;
