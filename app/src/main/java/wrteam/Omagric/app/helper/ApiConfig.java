package wrteam.Omagric.app.helper;
...
import wrteam.Omagric.app.model.Favorite;
import wrteam.Omagric.app.model.OrderTracker;
import wrteam.Omagric.app.model.PriceVariation;
import wrteam.Omagric.app.model.Product;
import wrteam.Omagric.app.model.Slider;
...
//                message = "Cannot connect to Internet...Please check your connection!";
    ...
    public static void RemoveAllItemFromCart(Activity activity, Session session) {
        Map<String, String> params = new HashMap<String, String>();
    ...
    public static void MultiPleAddOrRemoveFavorite(Activity activity, Session session, String productID, boolean isAdd) {
        Map<String, String> params = new HashMap<String, String>();
        if (isAdd) {
                ...
                if (result) {
                    try {
                        ...
                        if (!objectbject.getBoolean(Constant.ERROR)) {
                            ...
                            Constant.SETTINGS_MINIMUM_ORDER_AMOUNT = object.getDouble(Constant.MINIMUM_ORDER_AMOUNT);
                ...
                if (result) {
                    try {
                        ...
                        if (!object.getBoolean(Constant.ERROR)) {
                            ...
                            Constant.COUNTRY_CODE = object.getString(Constant.COUNTRY_CODE);
                            DrawerActivity.tvWallet.setText(activity.getResources().getString(R.string.wallet_balance) + "\t:\t" + Constant.SETTING_CURRENCY_SYMBOL + Constant.WALLET_BALANCE);
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
