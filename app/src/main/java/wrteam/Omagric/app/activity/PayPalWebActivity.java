...
import wrteam.Omagric.app.helper.PaymentModelClass;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("Completed"))
                                paymentModelClass.PlaceOrder(PayPalWebActivity.this, getString(R.string.paypal), itemNo, true, (Map<String, String>) getIntent().getSerializableExtra("params"), status);
                            else
                                paymentModelClass.PlaceOrder(PayPalWebActivity.this, getString(R.string.paypal), itemNo, false, (Map<String, String>) getIntent().getSerializableExtra("params"), status);
