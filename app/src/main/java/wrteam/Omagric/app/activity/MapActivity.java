...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void UpdateLocation(View view) {
        LoginActivity.edtaddress.setText(ApiConfig.getAddress(latitude, longitude, MapActivity.this));
        LoginActivity.mapFragment.getMapAsync(LoginActivity.mapReadyCallback);
        onBackPressed();
    }
}
